...
@section('content')
    <head>
        ...
        <!-- Favicon -->
        <link rel="icon" type="image/png" href="css/assets/images/favicon.png">
    </head>
    <body>
                ...
                <div class="col-lg-6">
                    <div class="banner-img" data-speed="0.05" data-revert="true">
                        ...
                        <div class="nail-img" data-aos="fade-up" data-aos-delay="900" data-aos-duration="1000" data-aos-once="true">
                            <img src="{{ url('css/ssets/images/home-one/nail-img.jpg') }}a" alt="Nail"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="features-card">
                        <div class="img">
                            <img src="{{ url('css/assets/images/features/features-img1.jpg') }}" alt="features"/>
                        </div>
                        <div class="content">
                            <div class="top-icon">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="features-card">
                        <div class="img">
                            <img src="{{ url('css/assets/images/features/features-img2.jpg') }}" alt="features"/>
                        </div>
                        <div class="content">
                            <div class="top-icon">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="features-card">
                        <div class="img">
                            <img src="{{ url('css/assets/images/features/features-img3.jpg') }}" alt="features"/>
                        </div>
                        <div class="content">
                            <div class="top-icon">
        ...
        <div class="container">
            <div class="section-title mb-45 text-center">
                ...
                <div class="section-vector">
                    <img src="{{ url('css/assets/images/shape/section-vector.png') }}" alt="vector"/>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-6">
                    <div class="services-card">
                        <a href="service-details.html">
                            <img src="{{ url('css/assets/images/services/services-img3.jpg') }}" alt="Services"/>
                        </a>
                        <div class="content">
                ...
                <div class="col-lg-4 col-6">
                    <div class="services-card">
                        <a href="service-details.html">
                            <img src="{{ url('css/assets/images/services/services-img4.jpg') }}" alt="Services"/>
                        </a>
                        <div class="content">
                ...
                <div class="col-lg-4 col-6">
                    <div class="services-card">
                        <a href="service-details.html">
                            <img src="{{ url('css/assets/images/services/services-img5.jpg') }}" alt="Services"/>
                        </a>
                        <div class="content">
                ...
                <div class="col-lg-4 col-6">
                    <div class="services-card">
                        <a href="service-details.html">
                            <img src="{{ url('css/assets/images/services/services-img6.jpg') }}" alt="Services"/>
                        </a>
                        <div class="content">
            ...
            <div class="services-vector">
                <img src="{{ url('css/assets/images/services/services-vector.png') }}" alt="vector"/>
            </div>
        </div>
    </div>
    <!-- Services Area End -->
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="products-card">
                        <div class="product-img">
                            <a href="shop-details.html">
                                <img src="{{ url('css/assets/images/products/product-img1.png') }}" alt="Products"/>
                            </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="products-card">
                        <div class="product-img">
                            <a href="shop-details.html">
                                <img src="{{ url('css/assets/images/products/product-img2.png') }}" alt="Products"/>
                            </a>
                            <ul class="products-action">
                                <li><a href="cart.html"><i class="ri-shopping-cart-line"></i></a></li>
                                <li><a href="compare.html"> <i class="ri-arrow-left-right-line"></i></a></li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="products-card">
                        <div class="product-img">
                            <a href="shop-details.html">
                                <img src="{{ url('css/assets/images/products/product-img3.png') }}" alt="Products"/>
                            </a>
                            <ul class="products-action">
                                <li><a href="cart.html"><i class="ri-shopping-cart-line"></i></a></li>
                                <li><a href="compare.html"> <i class="ri-arrow-left-right-line"></i></a></li>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="pricing-card">
                        <ul>
                            <li>
                                <img src="{{ url('css/assets/images/pricing/pricing-img1.jpg') }}" alt="Pricing"/>
                                <div class="content">
                            ...
                            <li>
                                <img src="{{ url('css/assets/images/pricing/pricing-img2.jpg') }}" alt="Pricing"/>
                                <div class="content">
                            ...
                            <li>
                                <img src="{{ url('css/assets/images/pricing/pricing-img3.jpg') }}" alt="Pricing"/>
                                <div class="content">
                ...
                <div class="col-lg-6">
                    <div class="pricing-card">
                        <ul>
                            <li>
                                <img src="{{ url('css/assets/images/pricing/pricing-img4.jpg') }}" alt="Pricing"/>
                                <div class="content">
                            ...
                            <li>
                                <img src="{{ url('css/assets/images/pricing/pricing-img5.jpg') }}" alt="Pricing"/>
                                <div class="content">
                            ...
                            <li>
                                <img src="{{ url('css/assets/images/pricing/pricing-img6.jpg') }}" alt="Pricing"/>
                                <div class="content">
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="team-card">
                        <div class="team-img">
                            <a href="team-details.html">
                                <img src="{{ url('css/assets/images/team/team-img1.jpg') }}" alt="Team"/>
                            </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-card">
                        <div class="team-img">
                            <a href="team-details.html">
                                <img src="{{ url('css/assets/images/team/team-img2.jpg') }}" alt="Team"/>
                            </a>
                            <ul class="social-links-btn">
                                <li class="share-btn"><i class="flaticon-arrow-pointing-to-right"></i></li>
                                <li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-card">
                        <div class="team-img">
                            <a href="team-details.html">
                                <img src="{{ url('css/assets/images/team/team-img3.jpg') }}" alt="Team"/>
                            </a>
                            <ul class="social-links-btn">
                                <li class="share-btn"><i class="flaticon-arrow-pointing-to-right"></i></li>
                                <li>
    ...
    <div class="testimonial-area section-bg pt-100 pb-70">
        <div class="container">
            ...
            <div class="testimonial-slider owl-carousel owl-theme">
                ...
                <div class="testimonial-item">
                    <img src="{{ url('css/assets/images/testimonial/testimonial-img2.jpg') }}" alt="Testimonial"/>
                ...
                <div class="testimonial-item">
                    <img src="{{ url('css/assets/images/testimonial/testimonial-img3.jpg') }}" alt="Testimonial"/>
                ...
                <div class="testimonial-item">
                    <img src="{{ url('css/assets/images/testimonial/testimonial-img4.jpg') }}" alt="Testimonial"/>
    ...
    <div class="booking-area pt-100 pb-70">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="book-img">
                        <img src="{{ url('css/assets/images/book/book-img1.jpg') }}" alt="Book"/>
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-card">
                        <a href="single-blog-1.html" class="img">
                            <img src="{{ url('css/assets/images/blog/blog-img1.jpg') }}" alt="Blog"/>
                        </a>
                        <div class="content">
                            <ul>
                                <li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-card">
                        <a href="single-blog-1.html" class="img">
                            <img src="{{ url('css/assets/images/blog/blog-img2.jpg') }}" alt="Blog"/>
                        </a>
                        <div class="content">
                            <ul>
                                <li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-card">
                        <a href="single-blog-1.html" class="img">
                            <img src="{{ url('css/assets/images/blog/blog-img3.jpg') }}" alt="Blog"/>
                        </a>
                        <div class="content">
                            <ul>
                                <li>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="footer-widget pe-5">
                        <div class="footer-logo">
                            <a href="index.blade.php">
                                <img src="{{ url('css/assets/images/logos/logo.png') }}" class="footer-logo1" alt="Images">
                            </a>
                            <a href="index.blade.php">
                                <img src="{{ url('css/assets/images/logos/logo-white.pn') }}g" class="footer-logo2" alt="Images">
                            </a>
                        </div>
                        <p>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-12">
                            <div class="products-quickView-image">
                                <img src="{{ url('css/assets/images/products/product-details.png') }}" alt="Product Details">
                            </div>
                        </div>
